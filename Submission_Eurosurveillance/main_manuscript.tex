...
Large-scale international gatherings accelerate infectious disease
importation from diverse source populations. The 2026 FIFA World
Cup will bring an estimated 1--5~million visitors to 11~US host
cities between June~11 and July~19, 2026---the largest tournament
in history.

\medskip
\noindent\textbf{AIM}\\
We estimated importation risk for five infectious diseases across
11~US venue cities in advance of the tournament to support
surveillance prioritization and public health preparedness.

\medskip
\noindent\textbf{METHODS}\\
We developed a Poisson importation framework for five diseases
(dengue fever, influenza, malaria, measles, and pertussis). Three
nested travel models were constructed: a baseline using routine
June~2024 arrivals; a World Cup--adjusted model with projected
visitor growth factors; and a schedule-driven model routing fans
by match assignment. WHO incidence and BTS T-100 routing fractions
were combined with Monte Carlo uncertainty propagation (5,000
draws) to yield median importation estimates with 95\% uncertainty
intervals.

\medskip
\noindent\textbf{RESULTS}\\
Dengue posed the highest importation risk at most venue cities
(median $>$10 expected importations from Brazil alone; 95\%
uncertainty interval: 5.9--33.1), robust across the full
literature-supported parameter range. Atlanta was the exception,
where malaria probability exceeded dengue, driven by direct travel
from West and Central Africa. Influenza ranked second at most
cities, coinciding with the Southern Hemisphere winter peak.
Background tourism accounted for the dominant share of importation
risk; the World Cup fan increment contributed approximately 8.3\%
of projected arrivals for qualifying nations.

\medskip
\noindent\textbf{CONCLUSION}\\
This framework, built entirely from publicly available data,
provides reproducible city-level importation risk estimates for
mass gathering events, extensible to additional diseases, cities,
and future international gatherings.
\end{abstract}
...
Figure~\ref{fig:ci_asym} in Appendix~B: diseases with upward-skewed CIs

...
dataset~\citep{BTS_T100}, which records nonstop international flight
...
Office (NTTO) 2025 Forecast Report~\citep{NTTO2025}.
...
Monthly Arrivals by Country of Residence dataset~\citep{CBP_I94}.
The COR data
...
World Population Prospects~\citep{PopUN2020}). The same $\rho_d$ and
$p_d$
...
FIFA event records for all 48 qualifying nations~\citep{FIFA2026_schedule}. Matches with at least one undetermined opponent
...
Global Dengue Surveillance dataset~\citep{WHO_dengue}. Dengue
...
National Unit Data~\citep{whoWMR2024}. Annual incidence was divided by 12 to obtain an
...
portal~\citep{WHO_immunization}. Annual
...
\textbf{Disease}
  ...
  & \textbf{Key reference ($\rho_d$)} \\
\midrule
Dengue
  & 0.06--0.26
  & 0.10
  & 0.50
  & Mild viraemic phase; $\sim$40\% of dengue travellers viremic on arrival
  & \citet{bhatt2013}; \citet{undurraga2013} \\
Malaria
  & 0.10--0.35
  & 0.20
  & 0.30
  & Severe illness; long incubation — most develop symptoms post-return
  & WHO WMR \citeyearpar{whoWMR2024} \\
Measles
  & 0.10--0.60
  & 0.60
  & 0.05
  & Prostrating illness; ambulatory only in short pre-rash prodrome
  & \citet{simons2012} \\
Pertussis
  & 0.01--0.10
  & 0.10
  & 0.70
  & Catarrhal stage mimics common cold; fully ambulatory and unrecognised
  & \citet{mclaughlin2016} \\
\bottomrule
\end{tabular}
\end{table}
...
for all four diseases across all eleven US venue cities under the
...
% ============================================================
\section*{Discussion (draft notes)}
% ============================================================
